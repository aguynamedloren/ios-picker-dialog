...
//  Askfast
//
//  Created by ask-04 on 01/02/18.
//  Copyright © 2018 Ask-fast. All rights reserved.
//
...
class PickerDialog: UIView, UIPickerViewDataSource, UIPickerViewDelegate {
  ...
  private func createContainerView() -> UIView {
    ...
    self.picker.setValue(UIColor(hexString: "#333333"), forKeyPath: "textColor")
  ...
  private func addButtonsToView(container: UIView) {
    ...
    self.cancelButton.setTitleColor(UIColor(hexString: "#555555"), for: UIControlState.normal)
    self.cancelButton.setTitleColor(UIColor(hexString: "#555555"), for: UIControlState.highlighted)
    ...
    self.doneButton.setTitleColor(UIColor(hexString: "#555555"), for: UIControlState.normal)
    self.doneButton.setTitleColor(UIColor(hexString: "#555555"), for: UIControlState.highlighted)
